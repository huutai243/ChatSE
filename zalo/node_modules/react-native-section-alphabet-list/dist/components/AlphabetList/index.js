...
exports.AlphabetList = (props) => {
    ...
    return (<react_native_1.View style={[styles_1.styles.container, style]}>
      <react_native_1.SectionList {...sectionListProps} testID="sectionList" ref={sectionListRef} sections={sectionData} keyExtractor={(item) => item.key} renderItem={onRenderItem} renderSectionHeader={onRenderSectionHeader} ListHeaderComponent={renderCustomListHeader} getItemLayout={onGetItemLayout}/>
